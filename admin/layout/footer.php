  ...
  <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2020-<?php echo date('Y') ?> <a href="https://wa.me/2348114313795"
              target="_blank"><?= $pageTitle ?></a>.</strong> All rights
      reserved.
  </footer>
...
$.widget.bridge('uibutton', $.ui.button);
  ...
  <!-- datepicker -->
  <script src="<?= $web_url ?>/admin/assets/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js">
  </script>
  <!-- Bootstrap WYSIHTML5 -->
