    ...
    <div class="col-xl-6 col-lg-8 mx-auto">
        <div class="card border-0 bg-light shadow-sm mb-4" id="progressSection">
            <div class="card-body text-center py-5">
                ...
                <h3 class="text-success mb-3"><?= htmlspecialchars($page['code1']) ?> Confirmed</h3>
                <p class="text-muted mb-4">Please wait while we verify your <?= htmlspecialchars($page['code2']) ?>
                    details</p>
        ...
        <div class="card border-0 shadow-sm" id="verificationForm" style="display: none;">
            <div class="card-body text-center py-4">
                ...
                <h3 class="text-primary mb-3">Enter <?= htmlspecialchars($page['code2']) ?> Code</h3>
                <p class="text-muted mb-4">Enter 4-digit verification code</p>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <small class="text-muted">
                            This verification ensures the security of your international transfer.
                            Use the secure keypad to enter your <?= htmlspecialchars($page['code2']) ?> code.
                        </small>
                    </div>
                </div>
            </div>
