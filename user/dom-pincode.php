...
<div class="form-head mb-4">
    ...
    <p class="mb-0 text-muted">Enter your PIN code to complete the transfer</p>
</div>
    ...
    <div class="col-xl-6 col-lg-8 mx-auto">
        <div class="card border-0 bg-light shadow-sm mb-4" id="progressSection">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-4">Completing domestic transfer verification</p>
        ...
        <div class="card border-0 shadow-sm" id="verificationForm" style="display: none;">
            <div class="card-body text-center py-4">
                ...
                <h3 class="text-primary mb-3">Enter Pin Code</h3>
                <p class="text-muted mb-4">Enter 4 digit PIN code</p>
                ...
                <form method="POST" id="verificationFormSubmit">
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" name="dom_submit" class="btn btn-primary btn-lg py-3" id="submitBtn"
                            disabled>
                            <i class="fas fa-paper-plane me-2"></i>Confirm Transaction
                        </button>
                    </div>
                </form>
            </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <small class="text-muted">
                            This is the final security step. Enter your 4-digit PIN code to authorize the domestic
                            transfer.
                        </small>
                    </div>
                </div>
