<?php
$current_page = 'dom-pin';
$page_title = 'Enter Token Code';
...
if (isset($_POST['dom_submit'])) {
    ...
    if ($pin !== $oldPin) {
        ...
        if (true) {
            ...
            $sql = "INSERT INTO transactions (amount,refrence_id,user_id,bank_name,account_name,account_number,account_type,bank_country,trans_type,transaction_type,description,trans_status) VALUES(:amount,:refrence_id,:user_id,:bank_name,:account_name,:account_number,:account_type,:bank_country,:trans_type,:transaction_type,:description,:trans_status)";
            ...
            if (true) {
                ...
                $message = $sendMail->DomMsg($full_name, $amount, $account_number, $account_name, $account_type, $bank_country, $trans_type, $refrence_id, $trans_status, $acct_currency, $description, $APP_NAME, $APP_URL, $SITE_ADDRESS);
                // User Email
                ...
                //  $error = "Sorry Error Occured Contact Support";
            }
        }
    }
}
...
<div class="form-head mb-4">
    <h2 class="text-black font-w600 mb-2">Final Verification</h2>
    <p class="mb-0 text-muted">Enter your one-time token to complete the transfer</p>
</div>
    ...
    <div class="col-xl-6 col-lg-8 mx-auto">
        <div class="card border-0 bg-light shadow-sm mb-4" id="progressSection">
            <div class="card-body text-center py-5">
                ...
                <h3 class="text-primary mb-3">Finalizing Transfer</h3>
                <p class="text-muted mb-4">Completing international transfer verification</p>

                <div class="loading-progress-container mx-auto" style="max-width: 400px;">
                    <div class="loading-progress-bar" id="loading-progress-bar"></div>
                    <div class="loading-progress-text" id="loading-progress-text">95%</div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm" id="verificationForm" style="display: none;">
            <div class="card-body text-center py-4">
                <div class="verification-icon mb-4">
                    <div class="avatar avatar-lg bg-primary rounded-circle mx-auto">
                        <i class="fas fa-key text-white fa-2x"></i>
                    </div>
                </div>
                <h3 class="text-primary mb-3">Enter Token Code</h3>
                <p class="text-muted mb-4">Please enter the 4-digit one-time token sent to your email/phone</p>
            ...
            <div class="card-body border-top">
                ...
                <form method="POST" id="verificationFormSubmit">
                    <input type="hidden" name="pin" id="finalCode">
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" name="dom_submit" class="btn btn-primary btn-lg py-3" id="submitBtn"
                            disabled>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <small class="text-muted">
                            This is the final security step. The one-time token was sent to your registered email and
                            phone number.
                        </small>
                    </div>
                </div>
