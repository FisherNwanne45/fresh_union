...
// Fetch user's beneficiaries from domestic table
$beneficiaries = [];
try {
...
<div class="form-head mb-4 d-flex justify-content-between align-items-center">
    <h2 class="text-black font-w600 mb-2">International Wire Transfer</h2>
                    ...
                    <form method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" required autocomplete="off" class="form-control ps-2"
                                        name="account_number" id="account_number" placeholder="0123456789"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="hidden" value="<?= $page['wirefee'] ?>" name="fee">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            $col_class = ($show_swift && $show_routine) ? "col-md-6" : "col-12";
                            ?>
                            ...
                            <div class="row">
                                ...
                                <?php if ($show_swift): ?>
                                    <div class="<?= $col_class ?> mb-3">
                                        <label for="swift_code" class="form-label">SWIFT Code <span
                                                class="text-danger">*</span></label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" required maxlength="11" autocomplete="off"
                                                class="form-control ps-2" name="swift_code" id="swift_code"
                                                placeholder="KJHG8XXXX">
                                ...
                                <?php if ($show_routine): ?>
                                    <div class="<?= $col_class ?> mb-3">
                                        <label for="routine_number" class="form-label">Routing Number <span
                                                class="text-danger">*</span></label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" required maxlength="11" autocomplete="off"
                                                class="form-control ps-2" name="routine_number" id="routine_number"
                                                placeholder="87654345678XXX">
                        ...
                        <div class="alert alert-info bg-light border-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span
                                        class="text-primary fw-bold"><?= $row['acct_currency'] ?><?= $page['wirefee'] ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions mt-4 pt-3 border-top">
                            <div class="row g-2">
                                ...
                                <div class="col-6">
                                    <button type="submit" class="btn btn-primary btn-lg w-100" name="wire-transfer">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">Secure International Transfer</h6>
                            <p class="text-muted mb-0">Your international transaction is protected by bank-level security
                                encryption and complies with international banking regulations.</p>
                        </div>
                    </div>
                </div>
            </div>
