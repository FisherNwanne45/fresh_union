    ...
    <div class="col-xl-6 col-lg-8 mx-auto">
        <div class="card border-0 bg-light shadow-sm mb-4" id="progressSection">
            <div class="card-body text-center py-5">
                ...
                <h3 class="text-success mb-3"><?= htmlspecialchars($page['code2']) ?> Confirmed</h3>
                <p class="text-muted mb-4">Please wait while we verify <?= htmlspecialchars($page['code3']) ?>
                    requirements</p>
        ...
        <div class="card border-0 shadow-sm" id="verificationForm" style="display: none;">
            <div class="card-body text-center py-4">
                ...
                <h3 class="text-info mb-3">Enter <?= htmlspecialchars($page['code3']) ?> Code</h3>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <small class="text-muted">
                            ...
                            Use the secure keypad to enter your <?= htmlspecialchars($page['code3']) ?> code.
                        </small>
                    </div>
                </div>
            </div>
