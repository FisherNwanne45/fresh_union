  ...
  var dzChartlist = (function () {
            ...
            datasets: [
              {
                ...
                data: [
                  12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14, 24, 21, 13,
            ...
            datasets: [
              {
                ...
                data: [
                  12, 20, 16, 13, 16, 24, 20, 21, 19, 23, 17, 14, 24, 21, 13,
                  15, 27, 29, 21, 11, 14, 19, 21, 17,
                ],
              },
            ],
    ...
    var widgetChart3 = function () {
      if (jQuery("#widgetChart3").length > 0) {
        const widgetChart3 = document
          ...
          .getContext("2d");
        //generate gradient
        const widgetChart3gradientStroke = widgetChart3.createLinearGradient(
          0,
          1,
          0,
          500
    ...
    var lineChart = function () {
      ...
      if (jQuery("#lineChart").length > 0) {
        ...
        //generate gradient
        const lineChart_3gradientStroke1 = lineChart.createLinearGradient(
          500,
          0,
          100,
          0
        ...
        const lineChart_3gradientStroke2 = lineChart.createLinearGradient(
          500,
          0,
          100,
          0
