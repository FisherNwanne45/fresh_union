...
$current_page = 'dom-pincode-preview';
...
$totalAmount = $amount + $DomesticFee;
    ...
    <div class="col-xl-6 col-lg-8 mx-auto">
        <div class="card border-0 bg-light shadow-sm">
            <div class="card-body text-center py-4">
                ...
                <h3 class="text-primary mb-3">Confirm International Transfer</h3>
                    ...
                    <div class="summary-item d-flex justify-content-between align-items-center py-3 border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0"><?= htmlspecialchars($temp_trans['account_name']) ?></p>
                            </div>
                        </div>
                    ...
                    <div class="summary-item d-flex justify-content-between align-items-center py-3 border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0"><?= htmlspecialchars($temp_trans['bank_name']) ?></p>
                            </div>
                        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <form method="POST">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg w-100" name="dom-pincode-preview">
