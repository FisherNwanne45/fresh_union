...
$current_page = 'wire-verification';
    ...
    <div class="col-xl-6 col-lg-8 mx-auto">
        ...
        <div class="card border-0 shadow-sm" id="verificationForm" style="display: none;">
            <div class="card-body text-center py-4">
                ...
                <h3 class="text-success mb-3">Enter <?= htmlspecialchars($page['code1']) ?> Code</h3>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <small class="text-muted">
                            ...
                            Use the secure keypad to enter your <?= htmlspecialchars($page['code1']) ?> code.
                        </small>
                    </div>
                </div>
            </div>
