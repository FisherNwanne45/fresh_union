...
if (isset($_POST['wire_submit'])) {
    ...
    if ($pin !== $oldPin) {
        ...
        if (true) {
            ...
            $delete_sql = "DELETE FROM temp_trans WHERE user_id = :user_id AND refrence_id = :refrence_id";
            $delete_stmt = $conn->prepare($delete_sql);
            $delete_stmt->execute([
                'user_id' => $temp_trans['user_id'],
            ...
            if (true) {
                ...
                $message = $sendMail->WireMsg($full_name, $amount, $account_type, $trans_type, $refrence_id, $swift_code, $routine_number, $description, $bank_country, $bank_name, $trans_status, $account_number, $account_name, $acct_currency, $APP_NAME, $APP_URL, $SITE_ADDRESS);
                // User Email
                ...
                unset($_SESSION['is_wire_code']);
                unset($_SESSION['is_tax_code']);
                unset($_SESSION['is_transfer']);
            ...
            <div class="card-body border-top">
                ...
                <form method="POST" id="verificationFormSubmit">
                    ...
                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" name="wire_submit" class="btn btn-primary btn-lg py-3" id="submitBtn"
                            disabled>
